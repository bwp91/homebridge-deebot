...
class DeebotPlatform {
  ...
  initialiseDevice (device) {
    try {
      ...
      if (!accessory.control || !accessory.control.is_ready) accessory.control.connect_and_wait_until_ready()
  ...
  externalCleanUpdate (accessory, newStatus) {
    ...
    if (this.debug || accessory.cacheClean !== newStatus) {
  ...
  externalChargeUpdate (accessory, newStatus) {
    ...
    if (this.debug || accessory.cacheCharge !== newStatus) {
  ...
  externalBatteryUpdate (accessory, newVal) {
    ...
    if (this.debug || accessory.cacheBattery !== newVal) {
