...
export default class {
  ...
  initialiseDevice(device) {
    try {
      ...
      // Add the 'air drying' switch service if it doesn't already exist and add the set handler to the 'air drying' switch on/off characteristic
      if (loadedDevice.hasMoppingSystem()) {
        const airDryingService = accessory.getService('Air Drying') || accessory.addService(this.hapServ.Switch, 'Air Drying', 'airdrying');
        ...
        this.log('[%s] No mopping system available.', accessory.displayName);
      }
