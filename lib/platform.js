...
export default class {
  ...
  externalTrueDetectUpdate(accessory, newVal) {
    try {
      // Log the received update
      accessory.log(`${platformLang.receiveCmd} [TrueDetect: ${newVal}]`);
      // accessory.logDebug(`${platformLang.receiveCmd} [TrueDetect: ${newVal}]`); // todo
      ...
      if (accessory.context.trueDetect !== newVal) {
        ...
        // Log the change
        accessory.log(`${platformLang.curTrueDetect} [${newVal}]`);
      }
